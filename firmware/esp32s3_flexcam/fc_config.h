...
#define FC_IMU_TASK_HZ       120      // 100 informes/s + margen, sin sondeo inútil a 200 Hz
#define FC_IMU_DEADZONE_DEG  0.05f    // responde a movimientos pequeños sin amplificar ruido
...
// 0.45..0.75 quita ruido sin introducir un retraso grande a 100 Hz.
#define FC_IMU_SMOOTH        0.60f
#define FC_HORIZON_SMOOTH    0.72f
#define FC_IMU_TIMEOUT_MS    1500     // sin datos -> "IMU no disponible"
#define FC_IMU_RETRY_MS      2000     // reintento de reconexión

// Relación física entre el BNO085 y el plano de la imagen. Cada valor es un
// eje firmado: +1=X, +2=Y, +3=Z, y negativo invierte ese eje. El valor por
// defecto supone el BNO085 paralelo a la cámara: X=derecha, Y=abajo y Z sale
// perpendicular al módulo. Si lo montas en otra cara, cambia estos DOS ejes;
// deben ser distintos. La rotación visual 0/90/180/270 de la web es aparte.
#define FC_IMU_CAMERA_RIGHT_AXIS  (+1)
#define FC_IMU_CAMERA_DOWN_AXIS   (+2)
#define FC_IMU_HORIZON_SIGN       (+1.0f)
// Cuando la cámara apunta casi exactamente arriba/abajo, la gravedad apenas
// se proyecta sobre la imagen y el horizonte no está matemáticamente definido.
#define FC_IMU_HORIZON_MIN_PROJECTION 0.08f
